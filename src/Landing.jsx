  ...
  return (
    <div>
      <div className="main">
        ...
        <button type="button" class="btn btn-dark btn-lg download-button" onClick={handleStart}> START</button>
      ...
      <section id="about">
        ...
        <button class="btn success success-button">Learn More</button>
        </div>
      </section>
      <section id="steps">
        <div className="step">
